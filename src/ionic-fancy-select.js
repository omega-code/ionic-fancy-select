  ...
  return {
    ...
    template: function(element, attrs) {
      if (attrs.templateUrl) {
        ...
        return '<label class="item item-input item-stacked-label"><span class="input-label select-label {{inputLabelCss}}">{{label}}</span><input type="text" placeholder="{{placeholder}}" ng-model="text" auto-advance ng-click="showItems($event)" ng-keypress="showItems($event)" class="{{selectInputCss}}"></label>'
